...
const ENGINES = [
  { id: 'GPT-5.1', label: ENGINE_CONFIG['GPT-5.1'].label, color: ENGINE_CONFIG['GPT-5.1'].color },
...
export default function ScoreCard({ leaderboard, userBrand }) {
  ...
  return (
    ...
    >
      <div className="score-hero" style={{ flex: '1 1 300px', padding: '40px 20px', borderRight: '1px solid var(--border-subtle)' }}>
        <div style={{ fontSize: 13, textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--text-secondary)', fontWeight: 600 }}>
          Brand Visibility Score
        </div>
        
        <div className="score-number" style={{ margin: '16px 0' }}>
      ...
      <div style={{ flex: '2 1 400px', padding: '32px 40px', background: 'rgba(0,0,0,0.4)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
